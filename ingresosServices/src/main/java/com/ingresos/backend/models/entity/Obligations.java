...
/**
 * Obligations generated by hbm2java
 */
@Entity
@Table(name = "obligations", catalog = "ingresosdb")
public class Obligations implements java.io.Serializable {
	...
	public Obligations(Date cat, int cbu, String description, boolean fdl, int luu, Date uat) {
		this.cat = cat;
		this.cbu = cbu;
