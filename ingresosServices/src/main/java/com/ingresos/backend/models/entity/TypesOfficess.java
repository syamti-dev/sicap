...
/**
 * TypesOfficess generated by hbm2java
 */
@Entity
@Table(name = "types_officess", catalog = "ingresosdb")
public class TypesOfficess implements java.io.Serializable {
	...
	public TypesOfficess() {
	}

	public TypesOfficess(Date cat, int cbu, String description, boolean fdl, int luu, String name, Date uat) {
		this.cat = cat;
		this.cbu = cbu;
