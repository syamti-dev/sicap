...
/**
 * TypesPolicy generated by hbm2java
 */
@Entity
@Table(name = "types_policy", catalog = "ingresosdb")
public class TypesPolicy implements java.io.Serializable {
	...
	public TypesPolicy(Date cat, int cbu, String description, boolean fdl, int luu, Date uat) {
		this.cat = cat;
		this.cbu = cbu;
